...
/**
* checker - help function to checks if stuff matches and if we in a loop
* @head: the head node
*
* Description: the function is checking if we are in a loop
* Return: check either Null or where we know a loop exists
